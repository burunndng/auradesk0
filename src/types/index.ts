// ============================================================
// SerK3tOS — Core Type Definitions
// ============================================================
...
export type OSAction =
  ...
  | { type: 'LOGOUT' }
  | { type: 'OPEN_WINDOW'; appId: string; title?: string; viewport?: { width: number; height: number } }
  | { type: 'CLOSE_WINDOW'; windowId: string }
  | { type: 'MINIMIZE_WINDOW'; windowId: string }
  | { type: 'MAXIMIZE_WINDOW'; windowId: string; viewport?: { width: number; height: number } }
